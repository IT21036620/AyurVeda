...
const Product = ({ image, product_name, id, price, rating, rate_count }) => {
  return (
    <div class="w-[310px] h-[500px] mb-[40px] block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-gray-800 hover:cursor-pointer hover:scale-110 hover:shadow-[0px_0px_10px_5px_#21BE21]">
      <a href="#">
        <img
